...
let StockMovementController = class StockMovementController {
    constructor(stockMvmService) {
        this.stockMvmService = stockMvmService;
    }
    findAllWarehousesByStck(warehouseID) {
...
], StockMovementController.prototype, "findAllWarehousesByStck", null);
StockMovementController = __decorate([
    (0, common_1.Controller)('stockMvm'),
    __metadata("design:paramtypes", [stckMvm_service_1.StockMovementService])
], StockMovementController);
exports.StockMovementController = StockMovementController;
//# sourceMappingURL=stckMvm.controller.js.map